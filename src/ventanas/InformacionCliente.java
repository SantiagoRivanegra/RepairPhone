...
public class InformacionCliente extends javax.swing.JFrame {
    ...
    public InformacionCliente() {
        initComponents();
        user = Login.user;
        nombreCL = GestionarCliente.nombreCliente;
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select * from clientes where nombre_cliente = '" + nombreCL + "'");
            ...
            System.err.println("Error al completar campos de texto");
        }
    }
    ...
    private void initComponents() {
        ...
        jButton_actualizarCliente.setBackground(new java.awt.Color(51, 51, 51));
        jButton_actualizarCliente.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jButton_actualizarCliente.setForeground(new java.awt.Color(153, 204, 255));
        jButton_actualizarCliente.setText("ACTUALIZAR");
        ...
        getContentPane().add(jButton_actualizarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 220, 150, 75));
    ...
    private void jButton_actualizarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_actualizarClienteActionPerformed
        ...
        if(validar == 0){
            try {
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement("update clientes set nombre_cliente=?, mail_cliente=?, telefono_cliente=?, direccion_cliente=?"
                    + ", CUIT=? where DNI ='" + dni + "'");

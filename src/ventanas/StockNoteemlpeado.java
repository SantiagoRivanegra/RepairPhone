 ...
 * @author Santiago
 */
public class StockNoteemlpeado extends javax.swing.JFrame {
    ...
    private void jButton_buscarNoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_buscarNoteActionPerformed
        ...
        if (marcaEquipo.equals("")){
            ...
            BusquedaNoteEmple busquedaNoteE = new BusquedaNoteEmple();
            busquedaNoteE.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockNoteemlpeado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockNoteemlpeado().setVisible(true);
            }
        });
    }
